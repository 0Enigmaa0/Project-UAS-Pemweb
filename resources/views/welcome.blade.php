            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('categories.index') }}">Matematika</a></li>
                        <li><a class="dropdown-item" href="{{ route('categories.index') }}">Sains</a></li>
                        <li><a class="dropdown-item" href="{{ route('categories.index') }}">Bahasa</a></li>
                        <li><a class="dropdown-item" href="{{ route('categories.index') }}">Sejarah</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('questions.trending') }}">Forum</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#help">Bantuan</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-primary" href="{{ route('login') }}">Login/Daftar</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="hero text-center">
    <div class="container">
        ...
        <div>
            <a href="{{ route('questions.ask') }}" class="btn btn-light btn-lg me-3">Ajukan Pertanyaan</a>
            <a href="{{ route('categories.index') }}" class="btn btn-outline-light btn-lg">Jelajahi Kategori</a>
        </div>
    </div>
</div>
            ...
            <div class="col-md-4">
                <div class="card feature-card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('questions.detail', ['id' => 1]) }}" class="stretched-link">Lihat Detail</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card feature-card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('questions.detail', ['id' => 2]) }}" class="stretched-link">Lihat Detail</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card feature-card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('questions.detail', ['id' => 3]) }}" class="stretched-link">Lihat Detail</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="text-center mt-4">
            <a href="{{ route('questions.trending') }}" class="btn btn-primary">Lihat Semua Pertanyaan</a>
        </div>
    </div>
</div>
