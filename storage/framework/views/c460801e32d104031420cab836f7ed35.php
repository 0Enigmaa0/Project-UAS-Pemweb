        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('home')); ?>"> <!-- Perbarui rute untuk home -->
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('home')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('home'))]); ?>
                        <i class="bi bi-house-door-fill"></i> <!-- Ikon Rumah -->
                        <?php echo e(__('Home')); ?>
...
<?php /**PATH C:\laragon\www\komunitas-belajar\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>